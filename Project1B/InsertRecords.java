...
public class InsertRecords {
    ...
    public static void insertIntoStudents() throws SQLException {
        String sql = "INSERT INTO students(snum, ssn, name, gender, dob, c_addr, c_phone, p_addr, p_phone)"
    ...
    public static void insertIntoDepartments() throws SQLException {
        String sql = "INSERT INTO departments(code, name, phone, college)"
    ...
    public static void insertIntoDegrees() throws SQLException {
        String sql = "INSERT INTO degrees(name, level, department_code)" + "VALUES ('Computer Science', 'BS', 401),"
    ...
    public static void insertIntoMajor() throws SQLException {
        String sql = "INSERT INTO major(snum, name, level)" + "VALUES (1001, 'Computer Science', 'BS'),"
    ...
    public static void insertIntoMinor() throws SQLException {
        String sql = "INSERT INTO minor(snum, name, level)" + "VALUES (1007, 'Applied Mathematics', 'MS'),"
                + "(1005, 'Applied Mathematics', 'MS')," + "(1001, 'Software Engineering', 'BS');";
        stmt.execute(sql);
    }

    public static void insertIntoCourses() throws SQLException {
        String sql = "INSERT INTO courses(number, name, description, credithours, level, department_code)"
    ...
    public static void insertIntoRegister() throws SQLException {
        String sql = "INSERT INTO register(snum, course_number, regtime, grade)" + "VALUES (1001, 363, 'Fall2020', 3),"
